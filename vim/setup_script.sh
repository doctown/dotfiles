...
git clone httpsgit://github.com/tpope/vim-rake.git ~/.vim/bundle/vim-rake
git clone httpsgit://github.com/tpope/vim-projectionist.git ~/.vim/bundle/vim-projectionist
